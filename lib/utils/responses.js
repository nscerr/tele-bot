...
module.exports = {
    ...
    CMD_HEALTH_ONLINE: (uptimeStr) => `<b>Server Aktif ᯓ ✈︎</b>\nuptime: ${uptimeStr} 🗿`,
    CMD_HEALTH_OFFLINE: '<b>off</b>\n\nserver lagi mati. coba ntar lagi 🗿',

    // --- Link Processing ---
    PROCESSING: 'sabar lagi diproses 🗿',
    LINK_UNSUPPORTED: 'Link apaan nih njir, kagak support. Kan udah gw bilang Facebook, Tiktok, ato X doang kocak 🗿',
    ...
    SLIDE_INFO_LIMIT: (count) => `<i>(cuma tombol donlod buat ${count} gambar pertama doang yak, sisanya donlot langsung di atas)</i> 🗿`,
    SLIDE_COUNTER: (current, total) => `<b>Total gambar slide:</b><i>(${current}/${total})</i>`,
    ...
    // --- Caption Building ---
    CAPTION_DESC: (desc) => `<b>Caption!:</b> ${desc}`,
