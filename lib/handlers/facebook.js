...
// --- PERUBAHAN 1: Tambahkan API Key Anda di sini ---
// Ganti 'key-rixzi' dengan API Key yang Anda dapatkan dari admin.
// Sangat disarankan untuk menggunakan environment variable (process.env.FB_API_KEY)
// untuk keamanan, tapi cara ini juga bisa bekerja.
const FB_API_KEY = 'key-rixzi'; 

async function handleFacebookLink(extractedLink, chatId) {
    try {
        // --- PERUBAHAN 2: Tambahkan parameter apikey ke URL ---
        // Kita menambahkan `&apikey=${FB_API_KEY}` di akhir URL.
