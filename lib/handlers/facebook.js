...
// ===========================================
// >> TAMBAHKAN BARIS INI
// Ganti 'KEY-RIXZI' dengan apikey yang kamu dapatkan dari admin!
const API_KEY = 'key-rixzi';
// ===========================================
...
async function handleFacebookLink(extractedLink, chatId) {
    try {
        // ===========================================
        // >> PERBARUI BARIS INI
        // Tambahkan &apikey=${API_KEY} ke URL
        const apiUrl = `${FB_DOWNLOADER_API}?link=${encodeURIComponent(extractedLink)}&apikey=${API_KEY}`;
        // ===========================================
